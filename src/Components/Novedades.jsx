                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="bg-gradient-to-r from-orange-500 to-orange-300 p-6 rounded-lg shadow-md">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span class="text-sm text-gray-950">15 de Marzo, 2024</span>
                        </div>
                    ...
                    <div class="bg-gradient-to-r from-orange-500 to-orange-300 p-6 rounded-lg shadow-md">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span class="text-sm text-gray-950">10 de Marzo, 2024</span>
                        </div>
                    ...
                    <div class="bg-gradient-to-r from-orange-500 to-orange-300 p-6 rounded-lg shadow-md">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span class="text-sm text-gray-950">5 de Marzo, 2024</span>
                        </div>
