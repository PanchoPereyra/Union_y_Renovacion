    ...
    <>
      <footer class="bg-gradient-to-r from-orange-500 to-orange-300 text-white py-10">
        ...
        <div class="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <h2 className="text-lg font-semibold mb-2 text-gray-950">Seguinos</h2>
            <div className="flex space-x-4">
              {/* <a href="#" className="bg-gray-800 hover:bg-gray-950 p-2 rounded-full transition">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-5 h-5" viewBox="0 0 24 24"></svg>
            </a>
